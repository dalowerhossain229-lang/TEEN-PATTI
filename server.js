...
// 🛫 ২. তিন পাত্তি কোর বেٹنگ ডিল রাউট (১০০০% এয়ার-টাইট ট্রানজেকশন প্রোটোকল বর্ম)
app.post('/api/teenpatti-deal', async (req, res) => {
    ...
    try {
        ...
        // আপনার স্ক্রিনশটের জিরো ক্যাশ এরর ওড়াতে সরাসরি ১ম হিটে বাজি ডেবিট রিকোয়েস্ট ফায়ার লক ওস্তাদ!
        ...
        while (isLoopActive && loopSafety < 150) {
            ...
            for (let i = 0; i < 3; i++) {
                ...
                playerCards.push(deck.splice(idx1, 1)[0]); 
